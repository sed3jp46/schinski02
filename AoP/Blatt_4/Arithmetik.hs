...
--4
belegungVonVariable2 :: String -> [(String, Integer)] -> Integer
belegungVonVariable2 a [] = error (a ++ " ist nicht deffiniert") --Abruchsfunktion, kommt auto., wenn alle Tupel überprüft wurden und kein Element in der Liste übrig bleibt
belegungVonVariable2 a ((b, c): xs)
    | a == b = c --überprüft ob der String aus der Eingabe sich mit dem aus dem Tupel gleicht, wenn ja wird der zugehörige Int ausgegeben 

    | a /= b = belegungVonVariable2 a xs --ist da um in der Liste vorranzuschreiten 
